  ...
  return (
    ...
    >
      ...
      <div className="w-full sm:w-6/12 m-1 p-4">
        <div className="
          group relative bg-neutral-800 text-white shadow-lg rounded-lg overflow-hidden 
          ...
          <div className="p-4 whitespace-normal break-words">
            ...
            <div className="flex flex-wrap mb-4">
              {element.tech.map((tech, index) => (
                <span
                  key={index}
                  className="bg-blue-600 text-white rounded-lg px-2 py-1 text-xs m-1"
                >
                  {tech}
                </span>
              ))}
      ...
      >
        <div
          className="inline-block bg-neutral-800 px-4 py-1 rounded-md text-white border border-gray-600"
          style={{
